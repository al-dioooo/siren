...
export default function DarkVesselsError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="border-fog bg-trench rounded-sm border px-4 py-16 text-center">
      <h2 className="font-display mb-1 text-lg font-semibold">Dark vessels tidak dapat dimuat</h2>
